...
def get_batch_activations(batch, device, model):
    # TODO: Test this
...
def calculate_activation_statistics(
    ...
    -- sigma : The covariance matrix of the activations of the pool_3 layer of
               the inception model.
    """
    act = get_file_activations(files, model, batch_size, dims, device, num_workers)
...
def compute_dataset_statistics(dataset_path):
    ...
    m, s = compute_statistics_of_path(
        "data/celeba/img_align_celeba/img_align_celeba", model, batch_size, dims, device
    )
